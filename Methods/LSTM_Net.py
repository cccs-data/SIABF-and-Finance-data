...
def lxy_LSTM_train(x, train_rate=0.7, train_net_len=100, pred_net_len=20, ep=500, learn_rate=1e-3, batch_size=50, hidden_s=50, hidden_l=3):
    ...
    model = MyLSTMNet(1, hidden_s, hidden_l, pred_net_len).to(device)
